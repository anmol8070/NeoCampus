<%-- 
    Document   : sinsert
    Created on : 3 Jul, 2025, 9:22:17 AM
    Author     : Anmol
--%>
...
<html>
    ...
    String n12 = request.getParameter("n12");
        ...
        int result = stmt.executeUpdate("INSERT INTO student VALUES('"+n1+"','"+n2+"','"+n3+"','"+n4+"','"+n5+"','"+n6+"','"+n7+"','"+n8+"','"+n9+"','"+n10+"','"+n11+"','"+n12+"')");

        if (result>0)
        {
            out.print("<h2>One Student Record Inserted Successfully!</h2>");
        } else
        {
            out.print("<h2> Failed to Insert Student Record.</h2>");
        }
%>
    </body>
</html>
