<%-- 
    Document   : sfinsert
    Created on : 3 Jul, 2025, 12:08:50 PM
    Author     : Anmol
--%>
...
<html>
    ...
    String n8 = request.getParameter("n8");
        ...
        ("INSERT INTO staff VALUES('"+n1+"','"+n2+"','"+n3+"','"+n4+"','"+n5+"','"+n6+"','"+n7+"','"+n8+"')");

        if (result>0)
        {
            out.print("<h2>One Staff Record Inserted Successfully!</h2>");
        } else
        {
            out.print("<h2> Failed to Insert Staff Record.</h2>");
        }
%>
    </body>
</html>
